...
export default function NavBar() {
  ...
  return (
    <nav className="w-full border-b border-gray-200 bg-white/80 backdrop-blur shadow-md dark:bg-gray-900 dark:border-gray-700">
      ...
      <div
        className={`sm:hidden ${menuOpen ? "block" : "hidden"} border-t border-gray-200 dark:border-gray-600`}
        role="dialog"
        aria-modal="true"
      >
        <div className="space-y-1 px-4 pb-4 pt-2">
          <a
            className="block rounded-md px-3 py-2 text-base font-medium text-mint-600 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800"
            href="/"
          >
            Dashboard
          </a>
